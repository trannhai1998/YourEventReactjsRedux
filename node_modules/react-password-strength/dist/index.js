...
var _zxcvbn = __webpack_require__(13);
...
var ReactPasswordStrength = function (_Component) {
  _inherits(ReactPasswordStrength, _Component);
  ...
  function ReactPasswordStrength() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReactPasswordStrength.__proto__ || Object.getPrototypeOf(ReactPasswordStrength)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      score: 0,
      isValid: false,
      password: ''
      ...
      _this.setState({
        ...
        _this.reactPasswordStrengthInput.value = '';
      ...
      var _this$props = _this.props,
          ...
          userInputs = _this$props.userInputs,
          minLength = _this$props.minLength;

      var password = _this.reactPasswordStrengthInput.value;
      ...
      if (isTooShort(password, minLength) === false) {
        result = (0, _zxcvbn2.default)(password, userInputs);
        score = result.score;
      }
      ...
      _this.setState({
        ...
        if (changeCallback !== null) {
          changeCallback(_this.state, result);
        }
      });
  ...
  _createClass(ReactPasswordStrength, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          namespaceClassName = _props.namespaceClassName,
          scoreWords = _props.scoreWords,
          style = _props.style,
          tooShortWord = _props.tooShortWord;


      var inputClasses = [namespaceClassName + '-input'];
      var wrapperClasses = [namespaceClassName, className ? className : '', password.length > 0 ? 'is-strength-' + score : ''];
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', _extends({
          ...
          ref: function ref(_ref2) {
            return _this2.reactPasswordStrengthInput = _ref2;
          },
          value: password
        })),
        _react2.default.createElement('div', { className: namespaceClassName + '-strength-bar' }),
...
ReactPasswordStrength.propTypes = {
  ...
  namespaceClassName: _propTypes2.default.string,
...
matching = __webpack_require__(14);

scoring = __webpack_require__(1);

time_estimates = __webpack_require__(16);

feedback = __webpack_require__(17);
...
frequency_lists = __webpack_require__(15);
