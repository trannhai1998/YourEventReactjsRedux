...
import {Image, Segment, Header, Divider, Grid, Button, Card, Icon, Label} from 'semantic-ui-react';
...
class PhotosPage extends Component {
  ...
  HandleSetMainPhoto = (photo) => async() => {
    ...
    render() {
        ...
        let filteredPhotos;
        if (photos) {
          filteredPhotos = photos.filter(photo => {return photo.url !== profile.photoURL})
        }
        return (
            <Segment>
                ...
                <Grid>
                    <Grid.Row />
                    <Grid.Column width={4}>
                        <Header color='teal' sub content='Step 1 - Add Photo' style={{marginBottom : '10px'}} />
                    ...
                    <Grid.Column width={1} />
                    <Grid.Column width={4}>
                        <Header sub color='teal' content='Step 2 - Resize image' style={{marginBottom : '10px'}} />
                        { files[0] && 
                          <Cropper 
                            style={{
                              height : 200 , 
                    ...
                    <Grid.Column width={1} />
                    <Grid.Column width={4}>
                        <Header sub color='teal' content='Step 3 - Preview and Upload'  style={{marginBottom : '10px'}} />
                ...
                <Divider/>
                <Label  color='teal' style={{fontSize: '20px',marginBottom:'20px'}} ribbon>
                    All Photos
                </Label>
